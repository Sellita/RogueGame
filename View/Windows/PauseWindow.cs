...
{
	sealed class PauseWindow : Window
	{
		...
		public PauseWindow(string firstButton, string secondButton, string thirdButton) : base(x: 0, y: 0, width: Console.WindowWidth, heigth: Console.WindowHeight, borderChar: '%')
		{
